          ...
          <Row>
            <Col span="19">
              <FormItem prop="tree_code" label="树木编号:" >
                <Input type="text" v-model="rootDetection.tree_code" placeholder="请输入树木编号"></Input>
              </FormItem>
            </Col>
          ...
          <Row>
            <Col span="20">
              <FormItem label="检测时间：" prop="test_time" class="error-tip">
                <DatePicker v-model="rootDetection.test_time"  type="datetime" placeholder="请选择日期" ></DatePicker>
              </FormItem>
            </Col>
          </Row>
          <Row>
            <Col span="19">
              <FormItem prop="pic1" label="根系水平分布及分布密度:" >
                <UploadImage :max-count="9"  :readonly="false" :url1="'/health_detection/root/'"
          ...
          <Row>
            <Col span="19">
              <FormItem prop="test_conclusion" label="检测结论:" >
                <Input v-model="rootDetection.test_conclusion" type="textarea" :autosize="{minRows: 2,maxRows: 10}" placeholder="Enter something..."
...
export default {
  ...
  mounted() {
    // this.rootDetection.root_section_pic = ['11CSDS_1690739653742965061.jpg','222_1690786128240577647.jpeg','A_20230731003402.png']
    // this.rootDetection.root_section_pic_urlList = ['http://49.232.244.63:5005/root_img/11CSDS_1690739653742965061.jpg',
    //   'http://49.232.244.63:5005/root_img/222_1690786128240577647.jpeg','http://49.232.244.63:5005/root_img/A_20230731003402.png']
