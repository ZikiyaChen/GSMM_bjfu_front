    ...
    <Form :model="trunkDetection" ref="trunk_form" :rules="ruleValidate" :label-width="160" style="margin: auto">
      <Row>
        <Col span="19">
          <FormItem prop="tree_code" label="树木编号:" >
            <Input type="text" v-model="trunkDetection.tree_code" placeholder="请输入树木编号"></Input>
          </FormItem>
        </Col>
      ...
      <Row>
        ...
        <FormItem prop="test_conclusion" label="检测结论:" >
          <Input v-model="trunkDetection.test_conclusion" type="textarea" :autosize="{minRows: 2,maxRows: 10}" placeholder="Enter something..."
