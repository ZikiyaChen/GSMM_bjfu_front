          ...
          <Row>
            <Col span="20">
              <FormItem label="检测时间：" prop="test_time" class="error-tip">
                <DatePicker v-model="trunkDetection.test_time"  type="datetime" placeholder="请选择日期" readonly></DatePicker>
              </FormItem>
            </Col>
          </Row>
          <Row>
            <Col span="19">
              <FormItem prop="height" label="检测高度:" >
                <Input v-model="trunkDetection.height" readonly><span slot="append">cm</span></Input>
              </FormItem>
            </Col>
          </Row>
          <Row>
            <Col span="19">
              <FormItem prop="perimeter" label="检测面主干周长:" >
                <Input v-model="trunkDetection.perimeter" readonly><span slot="append">cm</span></Input>
              </FormItem>
            </Col>
          </Row>
          <Row>
            <Col span="19">
              <FormItem prop="empty_rot_rate" label="检测面空腐率:" >
                <Input v-model="trunkDetection.empty_rot_rate" readonly><span slot="append"> % </span></Input>
              </FormItem>
            </Col>
          </Row>
          <Row>
            <Col span="19">
              <FormItem prop="probes_num" label="检测方法:" >
                <Input v-model="trunkDetection.probes_num" readonly></Input>
          ...
          <Row>
            <Col span="19">
              <FormItem prop="trunk_section_pic" label="检测图像:" >
                <UploadImage :max-count="9"  :readonly="true" :url1="'/health_detection/trunk/'"
...
export default {
  ...
  methods:{
    ...
    handleSubmit () {
      console.log('--submit---',this.trunkDetection.test_time)
      if(this.trunkDetection.test_time !==''){
        this.trunkDetection.test_time = dateToString(this.trunkDetection.test_time, 'yyyy-MM-dd hh:mm:ss')
      }
      this.changeLoading()
      this.$emit('onOK', { ...this.trunkDetection })
    },
